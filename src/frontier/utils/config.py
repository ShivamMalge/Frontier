...
``src/frontier/settings.py`` layers environment-variable overrides on top of it.
"""
...
# src/frontier/optimization/mean_variance.py and src/frontier/portfolio/
# compare.py; centralised here so the two can never disagree.
