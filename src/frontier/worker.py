"""RQ worker entry point.
    ...
    python -m frontier.worker                    # the same thing, without an install
    python -m frontier.worker --queues pipeline  # explicit queue
    python -m frontier.worker --burst            # drain the queue, then exit (for CI)
...
logger = logging.getLogger("frontier.worker")
