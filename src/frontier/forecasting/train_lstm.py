# src/frontier/forecasting/train_lstm.py

"""Legacy Keras LSTM training.

Superseded by ``src/frontier/forecasting/torch_lstm.py`` in Phase 3. Retained because it is the
...
from frontier.utils.config import (
    LOOKBACK_WINDOW,
    LSTM_BATCH_SIZE,
    LSTM_EPOCHS,
    MIN_OBSERVATIONS,
